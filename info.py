...
USERNAME = environ.get('USERNAME', "https://t.me/moviesrequestbot0") # ADMIN USERNAME
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '1002315832242'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/alltypemoviesrequest')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '1955406483').split()]
#---------------------------------------------------------------
#---------------------------------------------------------------
...
PREMIUM_POINT = 1500
#---------------------------------------------------------------
auth_channel_str = str(auth_channel) if auth_channel else None
AUTH_CHANNEL = int(auth_channel_str) if auth_channel_str and id_pattern.search(auth_channel_str) else None
